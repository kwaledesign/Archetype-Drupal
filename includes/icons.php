 ...
 */
function occam_feed_icon($variables) {
...
/**
 * Remove hard-coded gif
 */
function occam_calendar_ical_icon($vars) {
  $url = $vars['url'];
 ...
 * file icons
 */
function occam_file_link($variables) {
  $file = $variables['file'];
...
/*
function occam_file_icon($variables) {
  $file = $variables['file'];
