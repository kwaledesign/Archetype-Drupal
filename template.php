...
/**
 * @file
 * Contains functions to alter Drupal's markup for the Occam theme.
 *
 * The base Zen theme is designed to be easily extended by its sub-themes. 
 */
...
$path_occam = drupal_get_path('theme', 'occam');
  include_once './' . $path_occam . '/includes/css.inc.php';
  include_once './' . $path_occam . '/includes/js.inc.php';
  include_once './' . $path_occam . '/includes/icons.inc.php';
  include_once './' . $path_occam . '/includes/form.inc.php';
  include_once './' . $path_occam . '/includes/table.inc.php';
  include_once './' . $path_occam . '/includes/views.inc.php';
  include_once './' . $path_occam . '/includes/menu.inc.php';
  include_once './' . $path_occam . '/includes/pager.inc.php';
//  include_once './' . $path_occam . '/includes/book.inc.php';
  include_once './' . $path_occam . '/includes/system.inc.php';
  include_once './' . $path_occam . '/includes/date.inc.php';
  include_once './' . $path_occam . '/includes/misc.inc.php';
  include_once './' . $path_occam . '/includes/forum.inc.php';
  include_once './' . $path_occam . '/includes/blockify.inc.php';
  include_once './' . $path_occam . '/includes/comments.inc.php';
...
/** replace with hard coded function to get rid of internals directory?? **/
...
function zen_preprocess_html(&$variables, $hook) {
  ...
  $variables['path_to_occam'] = drupal_get_path('theme', 'occam');
  ...
  /** no need for this setting, replace with hard-coded var 'skip-link' **/
  /** remove setting from .info file and theme-settings file **/
...
/** move this to sub-theme's template **/
